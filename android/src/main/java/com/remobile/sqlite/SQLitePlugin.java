...
public class SQLitePlugin extends CordovaPlugin {
    ...
    @ReactMethod
    public void open(ReadableArray args, Callback success, Callback error) {
        String action = "open";
        try {
    ...
    @ReactMethod
    public void close(ReadableArray args, Callback success, Callback error) {
        String action = "close";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
    ...
    @ReactMethod
    public void delete(ReadableArray args, Callback success, Callback error) {
    ...
    @ReactMethod
    public void executeSqlBatch(ReadableArray args, Callback success) {
        String action = "executeSqlBatch";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, null));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
        }
    }
    ...
    @ReactMethod
    public void backgroundExecuteSqlBatch(ReadableArray args, Callback success) {
        String action = "backgroundExecuteSqlBatch";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, null));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
